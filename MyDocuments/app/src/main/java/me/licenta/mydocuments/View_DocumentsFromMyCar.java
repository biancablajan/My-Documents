...
public class View_DocumentsFromMyCar extends Activity {
    ...
    public static class AsyncTaskLoadFiles extends AsyncTask<Void, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            String targetPath = ExternalStorageDirectoryPath + "/My Documents/My Certificates/Documents From My Car";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_documentsfrommycar);
        ...
        iwBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent iwBack = new Intent(View_DocumentsFromMyCar.this, DocumentsFromMyCarActivity.class);
                        View_DocumentsFromMyCar.this.startActivity(iwBack);
                    }
                },1000);
        ...
        buttonReload.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                //mixed files
                myImageAdapter = new ImageAdapter(View_DocumentsFromMyCar.this);
                gridview.setAdapter(myImageAdapter);
                myAsyncTaskLoadFiles = new AsyncTaskLoadFiles(myImageAdapter);
                myAsyncTaskLoadFiles.execute();
            }});
        ...
        OnItemClickListener myOnItemClickListener = new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                                    long id) {
                Intent i = new Intent(View_DocumentsFromMyCar.this, DisplayClickedImage.class);
