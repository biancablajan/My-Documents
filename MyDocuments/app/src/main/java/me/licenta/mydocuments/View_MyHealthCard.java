...
public class View_MyHealthCard extends Activity {
    ...
    public static class AsyncTaskLoadFiles extends AsyncTask<Void, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            String targetPath = ExternalStorageDirectoryPath + "/My Documents/My Wallet/My Health Card";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_myhealthcard);
        ...
        iwBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iwBack = new Intent(View_MyHealthCard.this, MyHealthCardActivity.class);
                View_MyHealthCard.this.startActivity(iwBack);
            }
        });
        ...
        buttonReload.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                //mixed files
                myImageAdapter = new ImageAdapter(View_MyHealthCard.this);
                gridview.setAdapter(myImageAdapter);
                myAsyncTaskLoadFiles = new AsyncTaskLoadFiles(myImageAdapter);
                myAsyncTaskLoadFiles.execute();
            }});
    ...
    OnItemClickListener myOnItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
                                long id) {
            Intent i = new Intent(View_MyHealthCard.this, DisplayClickedImage.class);
