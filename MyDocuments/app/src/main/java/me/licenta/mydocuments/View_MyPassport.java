...
public class View_MyPassport extends Activity {
    ...
    public static class AsyncTaskLoadFiles extends AsyncTask<Void, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            String targetPath = ExternalStorageDirectoryPath + "/My Documents/My Wallet/My Passport";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_mypassport);
        ...
        iwBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iwBack = new Intent(View_MyPassport.this, MyPassportActivity.class);
                View_MyPassport.this.startActivity(iwBack);
            }
        });
        ...
        buttonReload.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                //mixed files
                myImageAdapter = new ImageAdapter(View_MyPassport.this);
                gridview.setAdapter(myImageAdapter);
                myAsyncTaskLoadFiles = new AsyncTaskLoadFiles(myImageAdapter);
                myAsyncTaskLoadFiles.execute();
            }});
    ...
    OnItemClickListener myOnItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
                                long id) {
            Intent i = new Intent(View_MyPassport.this, DisplayClickedImage.class);
