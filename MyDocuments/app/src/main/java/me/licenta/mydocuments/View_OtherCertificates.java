...
public class View_OtherCertificates extends Activity {
    ...
    public static class AsyncTaskLoadFiles extends AsyncTask<Void, String, Void> {
        ...
        protected void onPreExecute() {
            ...
            String targetPath = ExternalStorageDirectoryPath + "/My Documents/My Certificates/Other Certificates";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        iwBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent iwBack = new Intent(View_OtherCertificates.this, OtherCertificatesActivity.class);
                View_OtherCertificates.this.startActivity(iwBack);
            }
        });
        ...
        buttonReload.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                //mixed files
                myImageAdapter = new ImageAdapter(View_OtherCertificates.this);
                gridview.setAdapter(myImageAdapter);
                myAsyncTaskLoadFiles = new AsyncTaskLoadFiles(myImageAdapter);
                myAsyncTaskLoadFiles.execute();
            }});
    ...
    OnItemClickListener myOnItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
                                long id) {
            Intent i = new Intent(View_OtherCertificates.this, DisplayClickedImage.class);
