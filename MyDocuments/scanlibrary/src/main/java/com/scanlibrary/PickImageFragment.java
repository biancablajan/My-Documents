...
public class PickImageFragment extends Fragment {
    ...
    private File createImageFile() {
        clearTempImages();
        String current_folder = getArguments().getString(ScanConstants.CURRENT_FOLDER);
        String timeStamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new
                Date());
        Log.d("", "openCamera: Image PATH: " + ScanConstants.IMAGE_PATH+"Current Folder: "+current_folder);
        File file = new File(ScanConstants.IMAGE_PATH+current_folder, "IMG_" + timeStamp +
                ".jpg");
